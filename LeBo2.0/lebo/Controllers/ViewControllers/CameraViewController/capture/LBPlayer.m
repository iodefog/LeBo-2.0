...
@implementation LBPlayer

+ (id)sharedPlayer
{
    static LBPlayer *sharedInstance = nil;
...
{
    //这个函数没有实现引发崩溃  王勇添加-[LBPlayer playerItemDidNotReachEnd:]: unrecognized selector sent to instance 0x2103ccb0
...
- (void)play
{
    if(self.layer.superlayer != nil)
    {
        ...
        [super play];
        NSLog(@"%f",CMTimeGetSeconds(self.currentItem.duration));
