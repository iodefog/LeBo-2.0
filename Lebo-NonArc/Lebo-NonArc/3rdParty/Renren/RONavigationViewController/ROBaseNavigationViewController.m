...
- (id)init
{
    ...
    if (self) {
        ...
        [_navigationBar setBackgroundImage:bgimage forBarMetrics:UIBarMetricsDefault];
        ...
        [backBtn setBackgroundImage:[UIImage imageNamed:@"general_back.png"] forState:UIControlStateNormal];
        navItem.leftBarButtonItem = [[[UIBarButtonItem alloc]initWithCustomView:backBtn] autorelease];
